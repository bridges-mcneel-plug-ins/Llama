...
namespace Llama.Helpers.Mesh
{
    ...
    /// </summary>
    internal class TrimTrussTransfer : GH_Kernel.GH_Component
    {
        #region Constructors

        /// <summary>
        /// Initialises a new instance of the <see cref="TrimTrussTransfer"/> class.
        /// </summary>
        public TrimTrussTransfer()
          : base("Trim, Transfer and Truss", "TTT",
              "Trim a mesh with a set of boundary polylines defining an connected domain. Create a truss and transfer it on the initial configuration.",
...
*/
        ...
        public override Guid ComponentGuid => new Guid("{745E8927-9D78-4946-9852-54158C3C5861}");
